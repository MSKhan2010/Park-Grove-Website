...
function buildSubtitleWords() {
    const subtitle = document.querySelector('[data-split-text]');
    if (!subtitle) {
        return;
    }
...
function initScrollAnimations() {
    const animatedElements = document.querySelectorAll('.slide-in-left, .slide-in-right, .slide-up, .pop-in, .scroll-reveal');
...
function initHeroParallax() {
    const hero = document.querySelector('.admissions-hero');
