...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const buildLetterLoop = () => {
        const headings = document.querySelectorAll('[data-letter-loop]');
    ...
    const revealOnScroll = () => {
        const revealElements = document.querySelectorAll('.staff-reveal, .staff-stat, .promise-step');
